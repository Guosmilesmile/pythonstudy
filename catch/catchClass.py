...
class CatchClass:
	BookIndex = 1
	BookUrl = "http://all.qidian.com/Book/BookStore.aspx?ChannelId=21&SubCategoryId=-1&Tag=all&Size=-1&Action=-1&OrderId=6&P=all&PageIndex="+bytes(BookIndex)+"&update=-1&Vip=-1&Boutique=-1&SignStatus=-1"
	
	def SetBookIndex(self,bookindex):
		self.BookIndex = bookindex
	def SetBookUrl(self,bookurl):
